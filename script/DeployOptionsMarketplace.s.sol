...
contract DeployOptionsMarketplace is Script {
    address public constant MAINNET_PRICE_FEED_ID = 0xdeb288F737066589598e9214E782fa5A8eD689e8;

    function run() external returns (OptionsMarketplace) {
        vm.startBroadcast();
        OptionsMarketplace optionsMarketplace = new OptionsMarketplace(MAINNET_PRICE_FEED_ID);
        vm.stopBroadcast();
